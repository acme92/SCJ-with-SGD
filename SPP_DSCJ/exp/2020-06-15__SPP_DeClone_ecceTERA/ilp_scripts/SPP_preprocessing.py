...
def ortho(tree_file, ortho_file, tree_dict, rev_tree_dict, ortho_reln, rev_ortho_reln, cont_dict, logfile_1):
	branch_list = read_file(tree_file)
...
def get_gene_losses(gene_losses, nd_dict, rev_tree_dict, ortho_reln, cont_dict):
...
def get_gene_gains(gene_gains, ng_dict, rev_tree_dict, rev_ortho_reln, cont_dict):
	for species in rev_tree_dict:
		parent = rev_tree_dict[species]
		branch = (species, parent)
